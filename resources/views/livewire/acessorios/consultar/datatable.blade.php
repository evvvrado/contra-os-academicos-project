<div class="row">
    <div class="col-12">
        <div class="d-flex flex-row mb-3">
            ...
            <div class="ms-3">
                <i class="fas fa-pen-square iS" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"></i> Editar Acessório
            </div>
            <div class="ms-3">
                <i class="fa fa-cubes iS" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"></i> Listar Marcas
            </div>
            <div class="ms-3">
                <i style="color: #f46a6a!important;" data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir" class="fas fa-minus-circle iS"></i> Excluir Acessório
            </div>
        </div>
        <div class="row">
            <div class="col-12">
        ...
        <table
            ...
            <tbody>
                @foreach ($acessorios as $acessorio)
                    ...
                    @endphp
                    <tr>
                        <td>{{ $acessorio->nome }} - (@if($marca) {{ $marca->nome }} @else Sem marca padrão @endif)</td>
            
                        <td class="d-flex justify-content-between">
                            <a onclick="Livewire.emit('carregaModalEdicaoAcessorio', {{ $acessorio->id }})"
                            ...
                            <svg width="18" height="18"
                                onClick="editar_marca({{ $acessorio->id }}, @if($marca) '{{ $marca->id }}' @else null @endif)"
