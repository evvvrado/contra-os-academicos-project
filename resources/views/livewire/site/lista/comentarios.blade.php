<div>
    ...
    <style>
        ...
        .lista-comment::before,
        .lista-comment::after,
        .lista-comment-form::before,
        .lista-comment-form::after {
            content: "";
            display: table;
            clear: both;
        }
    ...
    <div class="container bootstrap snippets bootdey">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="post-comments">
                                    ...
                                    <?
                                                ...
                                                $verifica = ListaComentarioRegistro::whereListaId($lista->id)
                                                ->whereUsuarioSiteId(session()->get('usuario_site')['id'])
                                                ->whereListaComentarioId($comentario->id)
                                                ->first();
        ...
        @if ($porpagina < $lista->comentario->count()) 
