    ...
    @foreach ($produtos as $produto)
        <tr class="odd">
            ...
            <td class="text-center">
                <i class="fas fa-arrow-up fa-lg cpointer" @if($produto->lancamento) style="color: #45f248;" @endif data-bs-toggle="tooltip" data-bs-placement="top" @if($produto->lancamento) title="Retirar dos lancamentos" @else title="Marcar como lançamento" @endif wire:click="$emit('marcar_lancamento', {{ $produto->id }})"></i>                                            
            </td>
            <td class="text-center">
