<div class="row">
    <div class="col-12">
        <div class="d-flex flex-row mb-3">
            ...
            <div class="ms-3">
                <i class="fas fa-pen-square iS" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"></i> Editar Ingrediente
            </div>
            <div class="ms-3">
                <i class="fa fa-cubes iS" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"></i> Listar Marcas
            </div>
            <div class="ms-3">
                <i style="color: #f46a6a!important;" data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir" class="fas fa-minus-circle iS"></i> Excluir Ingrediente
            </div>
        </div>
        <div class="row">
            <div class="col-12">
