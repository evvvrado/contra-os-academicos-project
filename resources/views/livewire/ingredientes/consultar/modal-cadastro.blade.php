                ...
                <form wire:submit.prevent='salvar'>
                    <div class="row">
                        <div class="form-group col-6 col-lg-6 mt-3">
                            ...
                            <input id="nome" name="nome" type="text" placeholder="Insira o nome do ingrediente" class="form-control" wire:model="nome" required maxlength="100">
                        </div>

                        <div class="form-group col-6 col-lg-6 mt-3">
                            <label for="nome">Categoria</label>
                            <select class="form-control" name="ingrediente_categoria_id" wire:model='ingrediente_categoria_id' required>
