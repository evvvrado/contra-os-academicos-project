        ...
        <div class="col-9">
            ...
            <div class="row"">
                ...
                <a name="" id="button-add" class="btn" style="height: 100%; padding-left: 0;"
                    style="padding-left: 0;" href="{{ route('painel.anuncios.cadastro') }}">
                            ...
                            <table id="datatable"
                                ...
                                <tbody>
                                    @foreach ($anuncios as $anuncio)
                                        <tr class="odd">
                                            <td class="sorting_1 dtr-control">{{ $anuncio->nome }}</td>
                                            <td>{{ $anuncio->url }}</td>
                                                ...
                                                <div class="btn-group edit-table-button ">
                                                    ...
                                                    <div class="dropdown-menu" style="margin: 0px;">
                                                        <a class="dropdown-item"
                                                            href="{{ route('painel.anuncios.editar', ['anuncio' => $anuncio]) }}">Editar</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" style="color: red"
                                                            href="{{ route('painel.anuncios.deletar', ['anuncio' => $anuncio]) }}">Excluir</a>
                                                    </div>
                                                </div>
    ...
    <div class="col-3">
        ...
        <div class="card filter-body">
            <div class="card-body">
                ...
                <form id="form-filtro" action="{{ route('painel.anuncios') }}" method="POST">
                    @csrf
                    <div class="mb-3">
