                    ...
                    <div class="col-lx-12">
                        <div class="row">
                            ...
                            <div class="form-group col-6 col-lg-6 mt-3">
                                ...
                                <input required name="teor_alcoolico" type="number" step="0.01" min="0" class="form-control">
                            </div>

                            <div class="form-group col-6 col-lg-6 mt-3">
                                <label>Calorias</label>
                                <input required name="calorias" type="number" step="0.01" min="0" class="form-control">
                            </div>
                            ...
                            <div class="form-group col-6 col-lg-6 mt-3">
                                ...
                                <input required name="imagem_preview" type="file" class="form-control" style="height: 36px !important">
                            </div>

                            <div class="form-group col-6 col-lg-6 mt-3">
                                <label class="form-label">Imagem Detalhada</label>
                                <input required name="imagem_detalhada" type="file" class="form-control" style="height: 36px !important">
                            </div>
                        </div>
