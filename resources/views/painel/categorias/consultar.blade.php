...
@section('titulo')
Catalogo / <a style="color: unset" href="{{ route('painel.categorias') }}">Anunciante</a>
@endsection
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 68px;" aria-label="Age: activate to sort column ascending">Fim de
                                        Contrato</th>
                                    ...
                                    <td>
                                        <div class="btn-group edit-table-button ">
                                            ...
                                            <div class="dropdown-menu" style="margin: 0px;">
                                                ...
                                                <a class="dropdown-item" style="color: red" href="{{ route('painel.categoria.deletar', ['contrato' => $contrato]) }}">Excluir</a>
                                            </div>
                                        </div>
...
<div class="col-3">
    ...
    <div class="card filter-body">
        <div class="card-body">
            ...
            <form id="form-filtro" action="{{route('painel.categorias')}}" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="nome">Nome</label>
                    <input id="nome" name="nome" type="text" class="form-control" placeholder="Insira o nome" @if (isset($filtros) && isset($filtros['nome'])) value="{{ $filtros['nome'] }}" @endif>
                </div>
                <div class="mb-3">
                    <label for="manufacturername">Início de Contrato</label>
                    <input class="form-control" name="inicio" type="date" id="example-date-input" @if (isset($filtros) && isset($filtros['inicio'])) value="{{ $filtros['inicio'] }}" @endif>
                </div>
                <div class="mb-3">
                    <label for="manufacturerbrand">Fim de Contrato</label>
                    <input class="form-control" name="fim" type="date" id="example-date-input" @if (isset($filtros) && isset($filtros['fim'])) value="{{ $filtros['fim'] }}" @endif>
                </div>
                <div class="mb-3">
                    <label for="price">Valor de Contrato</label>
                    <input id="price" name="price" name="valor" type="tel" class="form-control" placeholder="Insira o valor" @if (isset($filtros) && isset($filtros['valor']))
                        value="{{ $filtros['valor'] }}" @endif>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" name="expositor_id">
                        ...
                        <option value="{{$expositor->id}}" @if(isset($filtros) && isset($filtros["expositor_id"]) && $filtros["expositor_id"]==$expositor->id) selected @endif>{{$expositor->nome}}
                        </option>
                        @endforeach
                    </select>
                </div>
