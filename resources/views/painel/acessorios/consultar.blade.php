...
@section('conteudo')
            ...
            <div class="row" style="padding: 0 15px">
                <div class=" col-sm-12 col-md-6 mb-3"
                    ...
                    <a name="" id="button-add" class="btn" style="height: 100%; padding-left: 0;"
                        style="padding-left: 0;" onclick="Livewire.emit('carregaModalCadastroAcessorio')">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @livewire('acessorios.consultar.datatable')
    ...
    @livewire('acessorios.consultar.modal-cadastro')
                ...
                <div class="modal-body">
                    <form action="{{ route('painel.marcas.cadastrar') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-3">
                            ...
                            <button type="button" data-bs-dismiss="modal" class="btn btn-secondary waves-effect waves-light">Cancelar</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.modal-content -->
