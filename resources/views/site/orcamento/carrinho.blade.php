                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            @foreach ($orcamento_produtos as $orcamento_produto)
                                                            ...
                                                            @if ($orcamento_produto->orcamento_produto_ingredientes->where('ingrediente_id', $ingrediente->id)->where('marca_id', $marca->id)->count() == 0)
                                                                ...
                                                                <div class="box caixa{{ $ingrediente->id }}">
                                                                    ...
                                                                    <input class="marca" mid="{{ $marca->id }}"
                                                                        onclick="altera_ingrediente({{ $marca->id }}, {{ $ingrediente->id }}, {{ $orcamento_produto->id }}, '{{ $ingrediente->nome }}')"
                                                                        type="checkbox" name="slide"
                                                                    ...
                                                                    <p>R$
                                                                        {{ number_format($marca->valor_embalagem, 2, ',', '.') }}
                                                                    </p>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                ...
                                @php
                                    OrcamentoProduto::where('id', $orcamento_produto->id)->update(['valor' => $total_produto]);
                                @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <picture class="foto-produto">
                                            <img src="{{ asset($produto_info->imagem_preview) }}"
                                                alt="imagem representativa">
                                        </picture>
                                    </td>
