...
@extends('site.template.main', ['titulo' => 'COA 404'])

@section('body_attr', 'id=404')
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <div class="row justify-content-center mt-5">
                        ...
                        <h4 class="mt-5">404</h4>
                        <p class="text-muted">Não conseguimos encontrar essa página em nosso site 😿</p>
